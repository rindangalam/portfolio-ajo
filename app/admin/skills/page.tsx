    ...
    return (
      <div className="retro-card rounded p-8 text-center">
        <p className="font-mono text-xs text-muted-foreground">
          Belum ada skill. Tambah skill pertama kamu di atas.
        </p>
      </div>
    );
  }
      ...
      {skills.map((skill) => (
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span className="rounded-full border border-accent/20 px-2 py-0.5 font-mono text-[9px] uppercase tracking-wider text-accent">
              {skill.category}
            </span>
    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="mt-1 font-mono text-[10px] text-muted-foreground">
          Kelola skill dan tingkat kemahiran yang ditampilkan di portofolio.
        </p>
      </div>
