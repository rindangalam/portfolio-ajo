...
export function ProfileEditor({ profile }: ProfileEditorProps) {
  ...
  return (
    <form action={updateProfile} className="space-y-6">
        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <button
              ...
              disabled={uploading}
              className="rounded-xl border border-secondary/30 bg-secondary/10 px-4 py-2 font-mono text-xs text-secondary transition-colors hover:bg-secondary/20"
            >
      ...
      <button
        type="submit"
        className="rounded-xl border border-secondary/30 bg-secondary/10 px-6 py-2 font-mono text-xs uppercase tracking-wider text-secondary transition-colors hover:bg-secondary/20"
      >
        Save Profile
      </button>
    </form>
